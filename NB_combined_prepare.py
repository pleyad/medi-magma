from NB_iuxray_prepare import dataset_iterator as iuxray_dataset_iterator
from NB_mimic_prepare import dataset_iterator as mimic_dataset_iterator
...
MIMIC_ROOT = Path("/srv/scratch1/nbodenmann/mimic-cxr/physionet.org/files/mimic-cxr-jpg/2.0.0/")
IUXRAY_ROOT = Path("/srv/scratch1/nbodenmann/iu-xray/")
...
def create_dataset():
        ...
        convert_dataset(
            data_dir=Path("/srv/scratch1/nbodenmann/prepared_iuxray_mimic_combined/train"),
            mode="cp",
